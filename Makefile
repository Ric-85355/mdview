# Makefile — created 2026-08-26, version 0.2.3.
...
test: $(BUILD_DIR)/mdview-c $(BUILD_DIR)/test-mdview-model $(BUILD_DIR)/dump-mdview-model
...
clean:
	rm -f $(BUILD_DIR)/mdview-c $(BUILD_DIR)/test-mdview-model \
		$(BUILD_DIR)/dump-mdview-model $(BUILD_DIR)/*.o
